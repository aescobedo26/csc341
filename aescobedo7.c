...
void swapper(int *pointa, int *pointb, int *pointc, int *pointd);
...
int main(void)
{
	...
	printf("\nBefore Swap\n");
	printf("value of expected = %d and value for valueReturned = %d\n", expected, valueReturned);
	printf("value of v1 = %d and value for v2 = %d", v1, v2);

	swapper(pointa,pointb,pointc,pointd);

	printf("\nAfter Swap\n");
	printf("new value for expected = %d and for valueReturned = %d\n", expected, valueReturned);
	printf("new value for v1 = %d and for v2 = %d", v1, v2);
